      ...
      <Container maxWidth="xl" sx={{ px: { xs: 2, md: 6 }, py: 6 }}>
        ...
        <Grid container spacing={6}>
          ...
          <Grid item xs={12} md={7} sx={{ animation: 'slideIn 0.6s ease-out' }}>
            ...
            {/* TRACKING TIMELINE (Only if not cancelled) */}
...
const Chip = ({ label, icon, sx }) => (
  <Box sx={{ display: 'inline-flex', alignItems: 'center', gap: 0.5, px: 1, borderRadius: '4px', ...sx }}>
    {icon}
    <span>{label}</span>
  </Box>
);
